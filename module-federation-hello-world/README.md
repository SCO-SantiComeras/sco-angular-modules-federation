...
- ``projects\hello-world\webpack.config.js``: Microfrontend config

## Installation and Usage

- Install packages: ``npm`` || ``yarn`` (!)*
- Start Micro Frontend (remote): ``ng serve hello-world -o``
- Make sure ``hello-world`` is started before ``shell`` is loaded into the browser
...
<pre>
    ...
    Update 'hello-world' for 'new-module' where you find the case in this files
</pre>
- Configure Webpack
<pre>
...
- Update project module folder 'projects/hello-world' -> 'projects/new-module'
- Update test module folder 'projects/hello-world/test' -> 'projects/new-module/new-module'
